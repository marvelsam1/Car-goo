    ...
    return ( 
        ...
        <div className="md:mx-40 shadow-lg md:mt-8 flex md:flex-row flex-col md:my-3 items-center">
            <div className="bg-blue text-white flex flex-col justify-start gap-4 md:py-36 py-3 md:px-16 px-10">
                <h1 className="md:text-5xl text-2xl md:w-[400px] font-semibold md:px-0 px-6 md:py-3 md:text-left text-center">Join us today to be a renter</h1>
            ...
            <div className="py-16 md:px-20 px-6">
                <form action="" className="flex flex-col justify-center">
                    <h1 className="text-white bg-blue py-3 px-6 text-center">Sign up with facebook</h1>
                    ...
                    <button className="bg-blue text-white py-3 px-6">Get Started</button>
                </form>
                <h1 className="text-center pt-10 text-[12px]">Already have an account? <NavLink to={'/Sign-In'}><span className="text-blue cursor-pointer font-medium">Sign In</span></NavLink></h1>
            </div>
        </div>
        </div>
     );
